...
Open a new web browser to access the https://demo.redhat.com/workshop/kukr6s[RHPDS page^].
...
Instructions on how to access the OpenShift console, _Gitea_ or Migration Toolkit for Applications along with userids and passwords can be found in the *shared environment detail page*.
...
Open a new browser to access the VSCode server that is provided from the *shared environment detail page*. Use the following credential.
...
[NOTE]
====
Replace YOUR_Openshift_API_URL with your own URL in the *shared environment detail page*.
====
