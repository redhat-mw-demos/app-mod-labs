...
The goal is to migrate the *Oracle virtual machine* from `Red Hat Virtualization` (RHV) to `OpenShift Virtualization` using the OpenShift Migration Toolkit for Virtualization (MTV).
...
* RHV Manager passsword: the password in the *Provision Messages*. (e.g., `ThvA2Ioa6Q4G`)
